...
export function migrante_consultar_todos(table){  //thead_migrantes, tbody_migrantes
    ...
    ,
     "migrantes",
        ...
        new $.fn.dataTable.Buttons(datatable, {buttons: [{text:"Detalles", action: ()=>{console.log(datatable.rows( { selected: true } ).ids()); migrante_eliminar(1)}, extend: "selectedSingle"}]});
