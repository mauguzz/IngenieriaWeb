/*create USER 'WebApplication'@'localhost' IDENTIFIED WITH mysql_native_password BY '123456';*/
/*Create USER 'WebApplication'@'localhost' IDENTIFIED WITH mysql_native_password BY '123456'

insert into Administrador values (1,'Mauricio','Gutiérrez','Montor', '5540358373', 'mauricio@gmail.com','123456');
insert into Funcionario values (1,1,'Noe','Torres','Cruz','5044389781','Noe@hotmail.com');

/*Ultima modificación 04-06-2020*/

drop database if exists Sistema_Migracion;
create database Sistema_Migracion;
use Sistema_Migracion;
...
/*				Datos de migrante					*/
        ...
        create table Causas_Migracion (
        Id_Causas int AUTO_INCREMENT,
        Causa varchar  (50),
        primary key (Id_Causas)
        );        
        
		create table Estado_De_Migrante (
        ...
        Id_Migrante int AUTO_INCREMENT,
        Nombre varchar (20),
        ...
        foreign key (Id_Nivel) references Nivel_Educativo(Id_Nivel),
        foreign key (Id_Famlia) references Familia (Id_Familia),
		foreign key (Id_Causa) references Causas_Migracion (Id_Causas),
        foreign key (Id_Estado) references Estado_De_Migrante (Id_Estado)
        );
        
	

 
/*				Datos de Punto de control					*/       
		
        create table Puntos_De_Control (
        Id_Punto_Control int auto_increment,
        Nombre varchar (50),
        Id_Estado int(11) ,
        Id_Municipio int(11),
        Telefono varchar (12),
...
/*					Información útil						*/
        ...
        create table Asistencia_Actividad_Cultural (
        Id_Actividad int,
        Id_Migrante int,
        Fecha date, 
        ...
        create table Ofertas_de_Trabajo (
        ...
        create table Asistencia_Oferta_Laboral (
        Id_Trabajo int,
        Id_Migrante int,
        Fecha date, 
 ...
 /*Registro Migrante-Punto de control*/ 
...
/*Corroboramos que no haya duplicidad*/
select * from Pais;
/*Agregamos Niveles Educativos*/
Insert into Nivel_Educativo values (1,'Sin estudios');
Insert into Nivel_Educativo values (NULL,'Educación Primaria');
Insert into Nivel_Educativo values (NULL,'Educación Secundaria');
Insert into Nivel_Educativo values (NULL,'Bachillerato');
Insert into Nivel_Educativo values (NULL,'Bachillerato tecnológico');
Insert into Nivel_Educativo values (NULL,'Técnico Superior Universitario');
Insert into Nivel_Educativo values (NULL,'Licenciatura/Ingeniería');
/*Corroboramos que no haya duplicidad*/
select * from nivel_educativo;
/*Agregamos los valores de familia*/
insert into Familia values (1,0);
insert into Familia values (NULL,1);
/*Corroboramos que no haya duplicidad*/
select * from Familia;
/*Agregamos los valores de causas*/ /*-------------------------------------Faltan Causas---------------------------------------*/
insert into Causas_Migracion values (1,'Falta de empleo');
insert into Causas_Migracion values (NULL,'Inseguridad');
/*Corroboramos que no haya duplicidad*/
select* from Causas_Migracion;
/*Agregamos los valores de estados*/ /*----------------------------------Pendiente de revisión--------------*/
insert into Estado_De_Migrante values (1,'Activo');
insert into Estado_De_Migrante values (NULL,'Inactivo');
/*Corroboramos que no haya duplicidad*/
select *from Estado_De_Migrante;

/*Agregamos Migrantes de prueba*/
						    /*ID	Nombre(s)	  Apellido P  Apellido M   Ciudad  Pais	  Oficio		Fecha Nacimiento Edad 	Tel_Contacto  Estudios Familia	Llave	  Causa	Estado													    *Ap*/ 
insert into Migrante values ('1', 'José Ricardo',  'Flores,'  ,'Lima',    'Petén',  4,  'Carpintero',   '1996-01-13'     ,24,  '5519360328',   6,       1,      '123456',  1,    1);
						    /*ID	Nombre(s)	  Apellido P  Apellido M   Ciudad  Pais	  Oficio		Fecha Nacimiento Edad 	Tel_Contacto  Estudios Familia	Llave	  Causa	Estado													    *Ap*/ 
insert into Migrante values (NULL, 'José María',  'Sánchez,'  ,'Lara',    'Lima',   4,  'Lechero',   '1999-02-22'     ,21,    '541070381',   6,       2,      '123456',  1,    1);
							/*ID	Nombre(s)	        Apellido P  Apellido M   Ciudad  Pais	  Oficio  Fecha Nacimiento   Edad 	Tel_Contacto  Estudios Familia	Llave	  Causa	Estado													    *Ap*/ 
insert into Migrante values (NULL, 'Mauricio Fabián',  'Sánchez,'  ,'Moreno',    'Quito', 2 ,  'Herrero',   '1999-09-19'     ,20,    '5540358373',   5,       1,      '123456',  2,    2);
							/*ID	Nombre(s)	 Apellido P  Apellido M   Ciudad  Pais	  Oficio  Fecha Nacimiento        Edad 	Tel_Contacto  Estudios Familia	Llave	  Causa	Estado													    *Ap*/ 
insert into Migrante values (NULL, 'Mauricio ',  'Gutiérrez'  ,'Montor',  'Bolivia', 4 ,  'Agricultor',   '1999-08-20'     ,20,    '7771493821',   5,       1,      '123456',  2,    1);

/*Corroboramos migrantes*/
select * from Migrante;

/*Agregamos los datos de los puntos de control*/
								/*	  ID             Nombre		   Id_Estado Id_Municipio	   Contacto			*/
insert into Puntos_De_Control values ('1','Frontera con Guatemala',   7   ,    187,			'5526228026');
insert into Puntos_De_Control values (Null,'Casa Migrante Tenabo' ,   4   ,    29,  		'5526281680');
insert into Puntos_De_Control values (Null,'Casa Migrante Juárez' ,   5   ,    47,  		'5526281980');
insert into Puntos_De_Control values (Null,'Casa Migrante Cuauhtémoc' ,   6   ,    75,  		'5526281680');
insert into Puntos_De_Control values (Null,'Casa Migrante El Tule' ,   8   ,    267,  		'5526281980');
insert into Puntos_De_Control values (Null,'Casa Migrante Rodeo' ,   10   ,    310,  		'5526281680');
insert into Puntos_De_Control values (Null,'Casa Migrante Ocampo' ,   11   ,    347,  		'5526281680');
/*Corroboramos los puntos de control*/
select *from Puntos_de_Control;
select * from Estados;
select * from Municipios;

/*Agregamos los valores de Registro*/
insert into Registro values (1,1,'2020-06-04',NULL,1);
...
/*Agregamos los valores de Usuario*/
insert into Administrador values (1,'Mauricio','Gutiérrez','Montor', '5540358373', 'mauricio@gmail.com','123456');
/*Corroboramos la información*/
...
create view Migrantes_Todos As
	select Migrante.Id_Migrante,
        ...
        AND Registro.Fecha_Entrada = MAX(SELECT Registro.Fecha_Entrada FROM Registro WHERE Registro.Id_Migrante = Migrante.Id_Migrante)
...
select Migrante.Id_Migrante,
        ...
        Causas_migracion.Causa
        from Migrante 
        Inner join Pais ON 
		Pais.Id_Pais=Migrante.Id_Pais
        inner join Nivel_Educativo ON
        Nivel_Educativo.Id_Nivel=Migrante.ID_Nivel
        inner join Causas_Migracion ON 
        Causas_Migracion.Id_Causas=Migrante.Id_Causa;
...
select 
        ...
        from Migrante
		inner join Registro on 
        Migrante.Id_Migrante=Registro.Id_Migrante
        inner join Puntos_de_Control ON
...
select 
	  ...
	  Migrante.Id_Migrante=Asistencia_Actividad_Cultural.Id_Migrante
      inner join Actividades ON
      Actividades.Id_Actividad=Asistencia_Actividad_Cultural.Id_Actividad;
